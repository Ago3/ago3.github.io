...
I am a member of Technical Staff at Cohere where I work on LLM Safety. I hold a PhD in Natural Language Processing from the [UKRI Centre for Doctoral Training in NLP](http://web.inf.ed.ac.uk/cdt/natural-language-processing) (The University of Edinburgh), where I worked on guideline-driven and explainable hate speech detection under the supervision of [Björn Ross](https://sweb.inf.ed.ac.uk/bross3/) and [Mirella Lapata](https://homepages.inf.ed.ac.uk/mlap/). My doctoral thesis focused on developing models that align with platform-specific moderation policies while remaining transparent and explainable, demonstrating that this approach can significantly reduce costs in real-world moderation pipelines. I was a member of the [EdinburghNLP](https://edinburghnlp.inf.ed.ac.uk/) group based at the [Institute for Language, Cognition and Computation](http://web.inf.ed.ac.uk/ilcc) (ILCC).
